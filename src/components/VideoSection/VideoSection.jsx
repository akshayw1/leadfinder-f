...
const VideoSection = () => {
  ...
  <div class="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
    ...
    <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 text-white sm:text-4xl md:mx-auto">
      <span class="relative inline-block">
        ...
        <span class="relative text-white">Boomnify</span>
      </span><br/>
      How we work
    </h2>
